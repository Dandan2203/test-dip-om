...
const features = [
  ...
  },
  {
    ...
    text: "Налаштовуваний дашборд із графіками доходів, витрат та підсумками.",
  },
  {
    icon: Target,
  ...
  },
  {
    ...
    text: "Показ нетипових витрат у застосунку на основі історії операцій.",
  },
  {
    icon: CreditCard,
    title: "Monobank",
...
const DEMO: { user: string; ai: string }[] = [
  ...
  },
  {
    ...
    ai: "Підготував дію: додати «Кіно» — 350 ₴. Потрібне підтвердження.",
  },
  {
