...
// Мінімальний безпечний рендер Markdown для відповідей асистента:
// **жирний**, абзаци (порожній рядок) і марковані списки (- / * / •).
// Без dangerouslySetInnerHTML — лише текстові вузли та <strong>, тож XSS неможливий.
